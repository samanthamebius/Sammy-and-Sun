...
public class Clutch extends Product{
    ...
    public Clutch(int productID, Double productPrice, String productLongName, String productShortName, ArrayList<String> productImages, String productDescription, String productDetails, String productCare){
