...
public class ToteBag extends Product{
    ...
    public ToteBag(int productID, Double productPrice, String productLongName, String productShortName, ArrayList<String> productImages, String productDescription, String productDetails, String productCare){
